  ...
  <main>
		...
		<div class="row">
			...
			<form method="POST" action="{{ route('password.email') }}">
				...
				<button name="login" id="login" class="btn btn-block form-btn" type="submit" value="Login">Send Link</button>
	...
	<div class="col-sm-7 px-0 d-none d-sm-block">
		<img src={{ asset('/images/forgot.jpg') }} alt="login image" class="form-img">
	</div>
  </main>
